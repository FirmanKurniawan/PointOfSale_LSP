                            ...
                            <div class="card button-card">
                                <div class="card-body">
                                    ...
                                    <div class="button-icon">
                                        ...
                                        <a href="{{route('stokppn_laporan')}}" class="btn btn-rounded btn-warning" target="_blank"><span class="btn-icon-left text-warning"><i
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$stokppns->ppn}}</td>
                                            <td><a href="{{route('stokppn_hapus', $stokppns->id)}}" class="confirmation"><i class="fa fa-trash-o" aria-hidden="true" title="Hapus"></i></a></td>
                                        </tr>
