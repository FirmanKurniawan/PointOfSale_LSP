                            ...
                            <div class="card button-card">
                                <div class="card-body">
                                    ...
                                    <div class="button-icon">
                                        ...
                                        <a href="{{route('kategori_tambah')}}" class="btn btn-rounded btn-warning" target="_blank"><span class="btn-icon-left text-warning"><i
                                ...
                                <div class="table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{$units->id}}</td>
                                            <td>{{$units->unit}}</td>
                                            <td><a href="{{route('unit_hapus', $units->id)}}" class="confirmation"><i class="fa fa-trash-o" aria-hidden="true" title="Hapus"></i></a></td>
