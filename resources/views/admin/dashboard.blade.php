                                ...
                                <div class="stat-widget-two">
                                    <div class="media">
                                        <div class="media-body">
                                            <h2 class="mt-0 mb-1 text-info">{{$count_user}}</h2><span class="">Total User</span>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-two">
                                    <div class="media">
                                        <div class="media-body">
                                            <h2 class="mt-0 mb-1 text-danger">{{$count_order}}</h2><span class="">Total Orders</span>
                                        </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="stat-widget-two">
                                    <div class="media">
                                        <div class="media-body">
                                            <h2 class="mt-0 mb-1 text-warning">{{$count_produk}}</h2><span class="">Total Product</span>
                                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card transparent-card">
                            <div class="card-header pb-0">
                                <h4 class="card-title mt-2"> Daftar Barang</h4>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-padded recent-order-list-table table-responsive-fix-big">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td><span class="label label-xl label-rounded label-warning">{{$produks->barcode}}</span>
                                                </td>
                                                <td class="text-muted">{{$produks->nama}}</td>
                                                <td><span class="text-pale-sky">{{$produks->stok}}</span>
                                                </td>
                                                <td><span class="text-pale-sky">{{$produks->harga_beli}}</span>
                                                </td>
                                                <td><span class="text-pale-sky">{{$produks->harga_jual}}</span>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
