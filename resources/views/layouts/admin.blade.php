    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo"><a href="{{route('admin')}}"><b><img src="/gleek/gleek/assets/images/logo.png" alt=""> </b><span class="brand-title"><img src="/gleek/gleek/assets/images/logo-text.png" alt=""></span></a>
            </div>
