    ...
    .rtl table tr td:nth-child(2) {
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tr class="total">
                ...
                <td>
            <br>
            <label class="text-label">Masukkan Jumlah Uang:</label>
            <input type="number" class="form-control" name="saldo" placeholder="Masukkan Jumlah Uang" required>
                            <div class="card-body">
